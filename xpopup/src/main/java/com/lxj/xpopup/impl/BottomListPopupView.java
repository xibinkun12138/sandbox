...
public class BottomListPopupView extends BottomPopupView {
  ...
  /**
   * @param bindLayoutId layoutId
   *     要求layoutId中必须有一个id为recyclerView的RecyclerView，如果你需要显示标题，则必须有一个id为tv_title的TextView
   * @param bindItemLayoutId itemLayoutId
   *     条目的布局id，要求布局中有id为iv_image的ImageView（非必须），和id为tv_text的TextView
   */
  ...
  protected void onCreate() {
    ...
    final EasyAdapter<String> adapter =
        new EasyAdapter<String>(
            Arrays.asList(data),
            bindItemLayoutId == 0 ? R.layout._xpopup_adapter_text_match : bindItemLayoutId) {
          @Override
          protected void bind(@NonNull ViewHolder holder, @NonNull String s, int position) {
            ...
            if (checkedPosition != -1) {
              if (holder.getViewOrNull(R.id.check_view) != null) {
                holder
                    .getView(R.id.check_view)
                    .setVisibility(position == checkedPosition ? VISIBLE : GONE);
              ...
              holder
                  ...
                  .setTextColor(
                      position == checkedPosition
                          ...
                          : getResources().getColor(R.color._xpopup_title_color));
            } else {
              if (holder.getViewOrNull(R.id.check_view) != null)
    ...
    adapter.setOnItemClickListener(
        new MultiItemTypeAdapter.SimpleOnItemClickListener() {
          @Override
  ...
  protected void applyDarkTheme() {
    ...
    findViewById(R.id.xpopup_divider)
        .setBackgroundColor(getResources().getColor(R.color._xpopup_list_dark_divider));
  ...
  protected void applyLightTheme() {
    ...
    findViewById(R.id.xpopup_divider)
        .setBackgroundColor(getResources().getColor(R.color._xpopup_list_divider));
    if (vv_divider != null)
