...
public class SortComparator implements Comparator {
  ...
  public int compare(Object o1, Object o2) {
    compareCallNum = 0;
    return compareString(((InstalledAppBean) o1).getName(), ((InstalledAppBean) o2).getName());
  }
  ...
  private int compareString(String o1, String o2) {
    ...
    // 否则，先判断字符类型
    String firstPinyinA = StringUtils.getSortLetter(o1).first;
    String firstPinyinB = StringUtils.getSortLetter(o2).first;
    if (compareCallNum == 1) {
    ...
    if (isHanzi(o1) && isHanzi(o2)) {
      ...
      //            compareResult = firstPinyinA.compareTo(firstPinyinB);
      compareResult =
          StringUtils.getSortLetter(o1).first.compareTo(StringUtils.getSortLetter(o2).first);
      if (compareResult != 0) {
        return compareResult;
      }
