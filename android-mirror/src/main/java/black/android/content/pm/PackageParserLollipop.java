...
public interface PackageParserLollipop {
  ...
  //    @BStaticMethod
  //    ActivityInfo generateActivityInfo(PackageParser.Activity service, int flag, PackageUserState
  // state, int userId);
  //
  //    @BStaticMethod
  ...
  //
  //    @BStaticMethod
  //    ProviderInfo generateProviderInfo(PackageParser.Provider service, int flag, PackageUserState
  // state, int userId);
  //
  //    @BStaticMethod
  //    ServiceInfo generateServiceInfo(PackageParser.Service service, int flag, PackageUserState
  // state, int userId);
