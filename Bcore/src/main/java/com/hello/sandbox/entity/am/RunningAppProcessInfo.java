...
public class RunningAppProcessInfo implements Parcelable {
  ...
  public void readFromParcel(Parcel source) {
    this.mAppProcessInfoList =
        source.createTypedArrayList(ActivityManager.RunningAppProcessInfo.CREATOR);
  }
  ...
  protected RunningAppProcessInfo(Parcel in) {
    this.mAppProcessInfoList =
        in.createTypedArrayList(ActivityManager.RunningAppProcessInfo.CREATOR);
  }
