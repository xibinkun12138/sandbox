 ...
 * href="http://java.sun.com/docs/books/effective/index.html">Effective Java</a> by Joshua Bloch.
 * Writing a good <code>hashCode</code> method is actually quite difficult. This class aims to
...
public class HashCodeBuilder implements Builder<Integer> {
  ...
  /**
   * Two randomly chosen, non-zero, odd numbers must be passed in. Ideally these should be different
   * for each class, however this is not vital.
   *
   ...
   *
   * <p>This is in accordance with the <quote>Effective Java</quote> design.
   *
