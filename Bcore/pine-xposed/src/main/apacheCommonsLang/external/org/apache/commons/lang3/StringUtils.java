...
public class StringUtils {
   ...
   *
   * <p>This method will use the first available implementation of: Java 6's {@link
   * java.text.Normalizer}, Java 1.3&ndash;1.5's {@code sun.text.Normalizer}
   *
   * <pre>
  ...
  /**
   * Use {@code java.text.Normalizer#normalize(CharSequence, Normalizer.Form)} (but be careful, this
   * class exists in Java 1.3, with an entirely different meaning!)
   *
    ...
    */
    if (InitStripAccents.java6NormalizeMethod == null
      ...
      throw new IllegalStateException(
          "java.text.Normalizer is not available", InitStripAccents.java6Exception);
    }
    String result;
    result =
        (String)
            InitStripAccents.java6NormalizeMethod.invoke(
                null, new Object[] {text, InitStripAccents.java6NormalizerFormNFD});
  ...
  private static String removeAccentsSUN(CharSequence text)
    ...
    */
    if (InitStripAccents.sunDecomposeMethod == null) {
      throw new IllegalStateException(
          "sun.text.Normalizer is not available", InitStripAccents.sunException);
    }
    String result;
    result =
        (String)
            InitStripAccents.sunDecomposeMethod.invoke(
                null, new Object[] {text, Boolean.FALSE, Integer.valueOf(0)});
  ...
  private static class InitStripAccents {
    ...
    static {
      ...
      try {
        ...
        _java6NormalizeMethod =
            normalizerClass.getMethod(
                "normalize", //$NON-NLS-1$
  ...
  public static boolean equalsIgnoreCase(CharSequence str1, CharSequence str2) {
    if (str1 == null || str2 == null) {
      ...
      return CharSequenceUtils.regionMatches(
          str1, true, 0, str2, 0, Math.max(str1.length(), str2.length()));
    }
  }
  ...
  private static int ordinalIndexOf(
      CharSequence str, CharSequence searchStr, int ordinal, boolean lastIndex) {
   ...
   * external.org.apache.commons.lang3.text.WordUtils#capitalize(String)}. A {@code null} input
   ...
   *
   * <p>For a word based algorithm, see {@link
   * external.org.apache.commons.lang3.text.WordUtils#uncapitalize(String)}. A {@code null} input
   * String returns {@code null}.
   *
   * <pre>
   ...
   *
   * <p>For a word based algorithm, see {@link
   * external.org.apache.commons.lang3.text.WordUtils#swapCase(String)}. A {@code null} input String
   * returns {@code null}.
   *
   * <pre>
